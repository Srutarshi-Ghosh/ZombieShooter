...
class Game:
    ...
    def load_data(self):
        ...
        for i in range(2, len(self.explosion_images['mine'])):
            self.explosion_images['mine'][i] = pygame.transform.scale(self.explosion_images['mine'][i], (EXPLOSION_ANIMATION['mine']['explosion_range'], EXPLOSION_ANIMATION['mine']['explosion_range']))
    ...
    def new(self):
        ...
        self.map = Tiledmap(os.path.join(self.img_folder, MAP))
    ...
    def draw(self):
        ...
        self.draw_text("ENEMIES: {}".format(len(self.mobs)), self.hud_font, 30, WHITE, WIDTH - 10, 10, align="ne")
        self.draw_text("SCORE: {}".format(self.score), self.hud_font, 30, WHITE, WIDTH // 2, 10, align="ne")
    ...
    def update(self):
        ...
        if hits and isinstance(hits[0], Mob):
            ...
            self.player.hit()
            self.player.pos -= vec(MOB_KNOCKBACK, 0).rotate(-self.player.rot)
    ...
    def show_start_screen(self):
        ...
        self.draw_text("Press Enter to Start", self.title_font, 75, RED, WIDTH / 2, HEIGHT * 3 / 4, align="center")
